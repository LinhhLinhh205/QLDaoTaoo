<%@ Page Title="Trang trị danh mục khoa" Language="C#" MasterPageFile="~/Site.Master"
    AutoEventWireup="true" CodeBehind="QLKhoa.aspx.cs" Inherits="QLDaoTao.QLKhoa" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Main" runat="server">
    ...
    <asp:ObjectDataSource ID="ods_Khoa" runat="server" DataObjectTypeName="QLDaoTao.Models.Khoa" DeleteMethod="Delete" InsertMethod="Insert" SelectMethod="getAll" TypeName="QLDaoTao.Models.KhoaDAO" UpdateMethod="Update"></asp:ObjectDataSource>
</asp:Content> 
